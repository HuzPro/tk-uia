...
| `tk.Radiobutton` | `Radiobutton` | `ButtonControl` - | `RadioButtonControl` 'a Radiobutton' | `RadioButtonControl` 'a Radiobutton' | SelectionItem | - | `app.radio("a Radiobutton")` |
| `tk.Scale` | `Scale` | `PaneControl` - | `SliderControl` - | `SliderControl` 'Volume' | RangeValue | - | `app.slider("Volume")` |
| `tk.Scrollbar` | `Scrollbar` | `ScrollBarControl` - | `ScrollBarControl` - | `ScrollBarControl` 'Scroll the results' |  | - | `app.scrollbar("Scroll the results")` |
...
| `tk.Listbox` | `Listbox` | `PaneControl` - | `ListControl` - | `ListControl` 'Search results' |  | - | `app.listbox("Search results")` |
...
| `tk.Menubutton` | `Menubutton` | `PaneControl` - | `ButtonControl` 'a Menubutton' | `ButtonControl` 'a Menubutton' |  | - | `app.button("a Menubutton")` |
| `tk.OptionMenu` | `Menubutton` | `PaneControl` - | `ButtonControl` 'one' | `ButtonControl` 'one' |  | - | `app.button("one")` |
...
*21 queries offered for this window by [pytest-uia](https://github.com/HuzPro/pytest-uia).*
...
| `ttk.Scale` | `TScale` | `PaneControl` - | `SliderControl` - | `SliderControl` 'Volume' | RangeValue | - | `app.slider("Volume")` |
...
| `ttk.Progressbar` | `TProgressbar` | `PaneControl` - | `ProgressBarControl` - | `ProgressBarControl` 'Upload progress' | RangeValue | NO_VALUE | `app.progressbar("Upload progress")` |
...
| `ttk.Notebook` | `TNotebook` | `PaneControl` - | `TabControl` - | `TabControl` 'Settings' |  | - | `app.tab_strip("Settings")` |
| `ttk.Treeview` | `Treeview` | `PaneControl` - | `TreeControl` - | `TreeControl` 'Task list' |  | - | `app.tree("Task list")` |
...
| `ttk.Menubutton` | `TMenubutton` | `PaneControl` - | `ButtonControl` 'a Menubutton' | `ButtonControl` 'a Menubutton' |  | - | `app.button("a Menubutton")` |
| `ttk.OptionMenu` | `TMenubutton` | `PaneControl` - | `ButtonControl` 'one' | `ButtonControl` 'one' |  | - | `app.button("one")` |
